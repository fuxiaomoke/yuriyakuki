...
语音转字幕小帮手是一个基于 PyQt6 和 ElevenLabs API 的图形界面工具，能够将音频文件转换为字幕文件（SRT/TXT格式）并附带JSON格式的详细转录结果。（如果对转换的SRT字幕的时间戳要求较高，建议和我搓的[另一个小工具](https://github.com/fuxiaomoke/heal-jimaku)搭配食用）
